...
(function ($) {
    ...
    $('a').on('click', function (e) {
        ...
        if (target.attr('target') === '_blank' || !target.attr('href').includes(window.location.origin)) {
            return;
        }

        if (target.attr('href').startsWith('javascript:') || !target.attr('href')) {
            return;
        }
