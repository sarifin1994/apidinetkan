<div class="action-div">
  @isset($data)
    ...
    @isset($edit)
      <a href="javascript:void(0)" class="edit-icon edit badge badge-info" data-id="{{ $data->id }}">
    ...
    @isset($delete)
      @if (isset($data->system_reserve) ? !$data->system_reserve : true)
        <a href="#confirmationModal{{ $data->id }}" data-bs-toggle="modal" class="delete-svg badge bg-danger">
          <i class="ti ti-trash remove-icon delete-confirmation"></i>
        </a>
        <!-- Delete Confirmation -->
