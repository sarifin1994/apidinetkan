    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <form x-load x-data="form" method="POST"
                            data-url="{{ route('dinetkan.settings.update.tripay') }}">
            ...
            <div class="col-lg-12">
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <form x-load x-data="form" method="POST"
                            data-url="{{ route('dinetkan.settings.update.site') }}" data-method="put">
                            <template x-if="success">
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <strong>{{ __('Success') }}!</strong> {{ __('Your settings have been updated.') }}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
            ...
            <div class="col-lg-12">
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="card-body p-4">
                        <h5 class="card-title fw-semibold">Server Monitoring Notification</h5>
                        <p class="card-subtitle mb-4">Manage your Site settings here.</p>

                        <form x-load x-data="form" method="POST"
                            data-url="{{ route('dinetkan.settings.update.updatemonitoringnotif') }}" data-method="put">
                            <template x-if="success">
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <strong>{{ __('Success') }}!</strong> {{ __('Your settings have been updated.') }}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                            ...
                            <div class="mb-3">
                                <label for="monitoring_notif_email" class="form-label">
                                    {{ __('Email Notification') }}
                                </label>

                                <div class="input-group">
                                    <template x-if="errors.monitoring_notif_email">
                                        <span class="invalid-feedback">
                                            <strong x-text="errors.monitoring_notif_email"></strong>
                                        </span>
                                    </template>
                                    <input type="text" name="monitoring_notif_email" id="monitoring_notif_email" class="form-control"
                                        placeholder="{{ __('Email, separator with ; if more than 1') }}" value="{{ $settings->monitoring_notif_email }}"
                                        :class="errors.monitoring_notif_email && 'is-invalid'">
                                </div>
                            </div>

                            <div class="mb-3">
                                <label for="monitoring_notif_whatsapp" class="form-label">
                                    {{ __('Notification Whatsapp') }}
                                </label>

                                <div class="input-group">
                                    <template x-if="errors.monitoring_notif_whatsapp">
                                        <span class="invalid-feedback">
                                            <strong x-text="errors.monitoring_notif_whatsapp"></strong>
                                        </span>
                                    </template>
                                    <input type="text" name="monitoring_notif_whatsapp" id="monitoring_notif_whatsapp" class="form-control"
                                    placeholder="{{ __('Whatsapp, separator with ; if more than 1') }}" value="{{ $settings->monitoring_notif_whatsapp }}"
                                    :class="errors.monitoring_notif_whatsapp && 'is-invalid'">
                                </div>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <form x-load x-data="form" method="POST"
                            data-url="{{ route('dinetkan.settings.update.license') }}" data-method="put">
                            <template x-if="success">
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <strong>{{ __('Success') }}!</strong> {{ __('Your settings have been updated.') }}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
