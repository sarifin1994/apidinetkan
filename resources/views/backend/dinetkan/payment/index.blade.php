...
@section('main')
@section('title', 'Owner Payment Gateway')
<div class="container-fluid">
    ...
    <div class="row">
        <div class="row mb-3 align-items-center">
            ...
            <div class="col-md-12">
                <select class="form-select" id="payment_gateway" name="payment_gateway" required>
                    ...
                    <option value="midtrans" {{ optional($midtrans)->status === 1 ? 'selected' : '' }}>Midtrans</option>
                    <option value="duitku" {{ optional($duitku)->status === 1 ? 'selected' : '' }}>Duitku</option>
                </select>
            </div>
        </div>
        <div class="col-md-12" id="pg_midtrans" style="display:none"> <!-- Card diperlebar -->
            <div class="card border rounded">
                {{-- <div class="card-header fw-bold ">Midtrans Configuration</div> --}}
                ...
                <div class="card-body">
                    <input type="hidden" id="midtrans_id" value="{{ optional($midtrans)->id }}">
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <select class="form-select rounded-end" id="status">
                                    <option value="1" {{ optional($midtrans)->status === 1 ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ optional($midtrans)->status === 0 ? 'selected' : '' }}>Nonaktif</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input class="form-control rounded-end" id="id_merchant" type="text"
                                    placeholder="G132706530" value="{{ optional($midtrans)->id_merchant }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input class="form-control rounded-end" id="client_key" type="text"
                                    placeholder="Mid-client-eHid7cD1W-D12dgk" value="{{ optional($midtrans)->client_key }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input class="form-control rounded-end" id="server_key" type="text"
                                    ...
                                    value="{{ optional($midtrans)->server_key }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input class="form-control rounded-end" id="admin_fee" type="number" placeholder="0"
                                    value="{{ optional($midtrans)->admin_fee }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-md-9 d-flex align-items-center">
                            <code id="notification-url"
                                class="d-block  p-2 rounded flex-grow-1">https://dev.radiusqu.com/midtrans/notification</code>
        ...
        <div class="col-md-12" id="pg_duitku" style="display:none"> <!-- Card diperlebar -->
            <div class="card border rounded">
                <div class="card-header fw-bold  d-flex justify-content-between align-items-center">
                ...
                <div class="card-body">
                    ...
                    <!-- Environment -->
                    <div class="row mb-3 align-items-center">
                        <label class="col-md-3 col-form-label text-muted" for="environment">Environment</label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-text ">
                                <span class="material-symbols-outlined">source_environment</span>
                                </span>
                                <select class="form-select rounded-end" id="environment">
                                    <option value="production" {{optional($duitku)->environment === 'production' ? 'selected' : '' }}>Production</option>
                                    <option value="development" {{ optional($duitku)->environment === 'development' ? 'selected' : '' }}>Development</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- URL Production -->
                    <div class="row mb-3 align-items-center">
                        <label class="col-md-3 col-form-label text-muted" for="url_production">URL Production</label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-text ">
                                    <span class="material-symbols-outlined">link</span>
                                </span>
                                <input class="form-control rounded-end" id="url_production" type="text"
                                    placeholder="" value="{{ optional($duitku)->url_production}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- URL Development -->
                    <div class="row mb-3 align-items-center">
                        <label class="col-md-3 col-form-label text-muted" for="url_development">URL Development</label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-text ">
                                    <span class="material-symbols-outlined">link</span>
                                </span>
                                <input class="form-control rounded-end" id="url_development" type="text"
                                    placeholder="" value="{{ optional($duitku)->url_development}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-md-9 d-flex align-items-center">
                            <code id="notification-url-duitku"
                                class="d-block  p-2 rounded flex-grow-1">https://dev.radiusqu.com/duitku/notification</code>
...
<script type="text/javascript">
    ...
    $('#update-duitku').click(function(e) {
        ...
        var data = {
            ...
            'url_production': $('#url_production').val(),
            'url_development': $('#url_development').val(),
        }
