        ...
        <div class="card">
          <div class="card-body">
            <div class="modal-body"> 
              <form id="updateFormDetail" method="post">  
                @csrf
                <div class="row">
                  ...
                  <div class="mb-3 col-6">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name"  value="{{isset($userdinetkan->company) ? $userdinetkan->company->name : '' }}">
                  </div>
                  <div class="mb-3 col-6">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                        <textarea required class="form-control" id="address" name="address" rows="3" :class="errors.address && 'is-invalid'">{{$userdinetkan->address}}</textarea>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive custom-scrollbar" id="row_create">
              <table id="myTableMrtg" class="table-hover display nowrap table" width="100%">
                <thead>
                  <th>ID</th>
                  <th>Name</th>
                </thead>
...
@push('scripts')
  <script>
    ...
    const form = $('#updateFormDetail');
      ...
      form.on('submit', function(e) {
        ...
        $.ajax({
          url: '{{route('dinetkan.users_dinetkan.update_new')}}',
          method: "POST",
          data: form.serialize(),
  ...
  function validate_data(data,field){
    $.ajaxSetup({
      ...
      $.ajax({
        url: baseurl + `/dinetkan/users_dinetkan/validate_data`,
        data: {
          field: field,
          field_data: data
        },
