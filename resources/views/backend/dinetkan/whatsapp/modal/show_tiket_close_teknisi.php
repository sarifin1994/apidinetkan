    <!-- Modal Show -->
    <div class="modal fade" id="show_tiket_close_teknisi" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Tiket Gangguan Closed (Untuk Teknisi)</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="tiket_close_teknisi" id="tiket_close_teknisi" style="height: 450px" class="form-control" placeholder=""
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Tiket Gangguan Closed (Untuk Teknisi)</b><br><br>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="updateClosedTeknisi" type="submit">
                        Save changes
                    </button>
                </div>
            </div>
