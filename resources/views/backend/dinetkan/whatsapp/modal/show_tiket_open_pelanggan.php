    <!-- Modal Show -->
    <div class="modal fade" id="show_tiket_open_pelanggan" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Tiket Gangguan Open (Untuk Pelanggan)</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="tiket_open_pelanggan" id="tiket_open_pelanggan" style="height: 450px" class="form-control" placeholder=""
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Tiket Gangguan Open (Untuk Pelanggan)</b><br><br>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="updateOpenPelanggan" type="submit">
                        Save changes
                    </button>
                </div>
            </div>
