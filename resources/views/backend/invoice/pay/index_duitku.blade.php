...
<head>
    <title>INV2 #{{ $invoice->no_invoice }} | {{ config('app.name') }}</title>
    <meta charset="utf-8">
                    ...
                    <div style="margin:0 auto;" class="container-fluid invoice-container">
                        <header>
                            <div class="row align-items-center text-center">
                                ...
                                <div class="col-sm-5 text-center text-sm-end">
                                    ...
                                    <p class="mb-0" style="font-weight: bold">Invoice #{{ $invoice->no_invoice }}
                                    <br>
                                    <p class="mb-0" style="font-weight: bold">invoice Date {{ \Carbon\Carbon::parse($invoice->invoice_date)->translatedFormat('d F Y') }}
                                    <br>
                                    <p class="mb-0" style="font-weight: bold">invoice Due {{ \Carbon\Carbon::parse($invoice->due_date)->translatedFormat('d F Y') }}
                                    </p>
                                </div>
                                    @if ($invoice->status === 'unpaid')
                                        <!-- <i class="fa fa-times"></i> -->
                                        <span style="font-style:italic; color:red; font-weight: bold;">BELUM LUNAS</span>
                                    </span>
                                    @else
                                        <i class="fa fa-check"></i> <span style="font-style:italic; color:green; font-weight: bold;">LUNAS</span></span>
                                    @endif
                            </div>
                        </header>
                        ...
                        <main class="mt-8">
                            ...
                            <div class="row">
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            ...
                                            <tr style="background-color:grey">
                                                <th style="font-weight:bold;color:black">Deskripsi</th>
                                                <th style="font-weight:bold;color:black">Periode</th>
                                                <th style="font-weight:bold;color:black">Jatuh Tempo</th>
                                                <th class="text-end" style="font-weight:bold;color:black">Total</th>
                                            </tr>
                                            <!-- end row -->
                                        </thead>
                                        <tbody>
                                            <!-- start row -->
                                            <tr>
                                                <td style="font-weight:bold;color:black">{{ $invoice->item }} <br>{{ $invoice->subscribe }}</td>
                                            ...
                                            @if($ad->no_invoice == $invoice->no_invoice && $ad->id_pelanggan_pppoe == $invoice->rpppoe->id_pelanggan)
                                            <tr>
                                                <td style="font-weight:bold;color:black">Ad on | {{ $ad->description }}</td>
                                                <td></td>
                                                <td></td>
                                                <td class="text-end">
											...
											@if($ad->ppn > 0)
												<tr>
                                                <td style="font-weight:bold;color:black">Ad on | PPN {{ $ad->description }}</td>
                                                <td></td>
                                                <td></td>
                                                <td class="text-end">
                                                    Rp {{ number_format($ad->price * $ad->ppn / 100, 0, '.', '.') }}
                                                </td>
                                            </tr>
											@endif
                                            @endif
                                ...
                                @php
                                    ...
                                    $total = $invoice->price + $amount_ppn - $amount_discount + $total_price;
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="text-end mt-3">
                                        @if ($invoice->status === 'unpaid')
                                            <button width="100%" id="pay-button" data-id="{{ $invoice->id }}"
                                                data-ppp="{{ $ppp->id }}"
                        ...
                        <footer class="text-center" style="font-size: 14px; font-style: italic;">
                            <div class="card-body px-5 py-4">
                                ...
                                Pembayaran menggunakan link ini akan langsung diproses otomatis oleh sistem.</b><br>
                                Harap selesaikan sebelum jatuh tempo agar tidak terkena isolir layanan.</a>
                                </div>
