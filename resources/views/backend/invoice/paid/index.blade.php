...
<div class="container-lg">
    ...
    <div class="row align-items-center mb-7">
        ...
        <div class="col">
            ...
            <!-- Heading -->
            <h1 class="fs-4 mb-0">Invoice Paid</h1>
        </div>
        <div class="col-12 col-sm-auto mt-4 mt-sm-0">
            <!-- Action -->
            {{-- @include('backend.invoice.paid.modal.create_invoice') --}}
            ...
            {{-- <button class="btn btn-danger me-2" id="unpayMassal" disabled> <span
                    class="material-symbols-outlined me-1">delete_history</span>UNPAY <span
                    class="row-count badge bg-dark text-light fs-7"></span></button> --}}
                    @if(multi_auth()->role !== 'Mitra')
            <button class="btn btn-success me-2 mb-2" data-bs-toggle="modal" id="printMassal"
                data-bs-target="#print_invoice" disabled>
                <span class="material-symbols-outlined me-1">file_save</span>Print <span
                    class="row-count badge bg-dark text-light fs-7"></span></button>
                ...
                <div class="card-body px-4 py-2">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <!-- Text -->
                            <div class="fs-6 fw-semibold" id="totalpaid"></div>
                        </div>
                        <div class="col-auto">
                            <!-- Avatar -->
                            <div class="fs-1 text-body-secondary">
            ...
            <div class="card bg-body-tertiary border-transparent">
                <div class="card-body px-4 py-2">
                    <div class="row align-items-center">
                        <div class="col">
                            <!-- Heading -->
                            <h4 class="fs-sm fw-normal mb-1">TOTAL BAYAR</h4>

                            <!-- Text -->
                            <div class="fs-6 fw-semibold text-success" id="totalnominal"></div>
                        </div>
                        <div class="col-auto">
                            <!-- Avatar -->
                            <div class="fs-1 text-body-secondary">
                ...
                <div class="card-body px-4 py-2">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <!-- Text -->
                            <div class="fs-6 fw-semibold text-success" id="totalkomisi"></div>
                        </div>
                        <div class="col-auto">
                            <!-- Avatar -->
                            <div class="fs-1 text-body-secondary">
