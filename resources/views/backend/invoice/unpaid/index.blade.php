...
<div class="container-lg">
    ...
    <div class="row align-items-center mb-7">
        ...
        <div class="col">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-2">
                    <li class="breadcrumb-item"><a class="text-body-secondary" href="#">Invoice</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Unpaid</li>
                </ol>
            </nav>

            <!-- Heading -->
            <h1 class="fs-4 mb-0">Invoice Unpaid</h1>
        </div>
        <div class="col-12 col-sm-auto mt-4 mt-sm-0">
            ...
            <button class="btn btn-primary me-2 mb-2" data-bs-toggle="modal" data-bs-target="#create_invoice">
                <span class="material-symbols-outlined me-1">add</span>Manual</button>
            @endif
            <button class="btn btn-danger me-2 mb-2" id="payMassal" disabled> <span
                    class="material-symbols-outlined me-1">file_export</span>PAY <span
                    class="row-count badge bg-dark text-white fs-7"></span></button>
                    @if(multi_auth()->role !== 'Mitra')
            <button class="btn btn-success me-2 mb-2 text-white" data-bs-toggle="modal" id="printMassal" data-bs-target="#print_invoice" disabled>
                        <span class="material-symbols-outlined text-white me-1">file_save</span>Print <span
                        class="row-count badge bg-dark text-white fs-7"></span></button>
            <button onclick="downloadExcel()" class="btn btn-warning text-white mb-2" id="btn-export" disabled>
                <span class="material-symbols-outlined me-1">file_save</span>Export <span
                    class="row-count badge bg-dark text-white fs-7"></span></button>
                    @endif
    ...
    <div class="row">
                ...
                <div class="card bg-body-tertiary border-transparent mb-4">
                    <div class="card-body px-4 py-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <!-- Heading -->
                                <h4 class="fs-sm fw-normal text-body-secondary mb-1">PERIODE INVOICE</h4>

                                <!-- Text -->
                                @php
                                    $now = \Carbon\Carbon::now()->format('F-Y');
                                @endphp
                                <input type="text" readonly class="form-select p-0 fs-8 fw-bold border"
                                    id="periode" name="periode" placeholder="Pilih Periode">
                            </div>
                            <div class="col-auto">
                                <!-- Avatar -->
                ...
                <div class="card bg-body-tertiary border-transparent mb-4">
                    <div class="card-body px-4 py-2">
                        <div class="row align-items-center">
                            <div class="col">
                                <!-- Heading -->
                                <h4 class="fs-sm fw-normal mb-1">TOTAL INVOICE</h4>

                                <!-- Text -->
                                <div class="fs-6 fw-semibold" id="totalunpaid"></div>
                            </div>
                            <div class="col-auto">
                                <!-- Avatar -->
                                <div class="fs-1 text-body-secondary">
            ...
            <div class="col-12 col-md-8 col-xxl-3 mb-4 mb-md-0">
                <div class="card bg-body-tertiary border-transparent">
                    <div class="card-body px-4 py-2">
                        <div class="row align-items-center">
                            <div class="col">
                                <!-- Heading -->
                                <h4 class="fs-sm fw-normal mb-1">TOTAL TAGIHAN</h4>

                                <!-- Text -->
                                <div class="fs-6 fw-semibold text-danger" id="totaltagihan"></div>
                            </div>
                            <div class="col-auto">
                                <!-- Avatar -->
                                <div class="fs-1 text-body-secondary">
                ...
                <div class="card bg-body-tertiary border-transparent">
                    <div class="card-body px-4 py-2">
                        <div class="row align-items-center">
                            <div class="col">
                                <!-- Heading -->
                                <h4 class="fs-sm fw-normal mb-1">TOTAL FEE MITRA</h4>

                                <!-- Text -->
                                <div class="fs-6 fw-semibold text-danger" id="totalkomisi"></div>
                            </div>
                            <div class="col-auto">
                                <!-- Avatar -->
                                <div class="fs-1 text-body-secondary">
