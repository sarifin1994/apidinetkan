...
@foreach ($invoices as $invoice)
    ...
    <body>
            ...
            <tr>
                <td>
                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                        class="fullTable" style="border-radius: 10px 10px 0 0;">
                                        ...
                                        <tr>
                                            <td>
                                                <table width="220" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left">  <img style="width:200px" src="/storage/logo/{{ $company->logo }}" alt=""
                                                                class="mb-3" /></td>
                                                        </tr>
                                                        <tr class="hiddenMobile">
                                                            <td height="40"></td>
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                @if ($invoice->status === 'unpaid')
                                                                    <small>Status <span
                                                                            style="color:red">UNPAID</span></small>
                                                                @else
                                                                    <small>Status <span
                                                                            style="color:green">PAID</span></small>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    </tbody>
        ...
        <!-- /Total -->
        <!-- Information -->
        <table width="100%" border="0" style="margin-top:30px" cellpadding="0" cellspacing="0"
        ...
        <!-- /Information -->
        <table width="100%" style="margin-top:50px" border="0" cellpadding="0" cellspacing="0"
            align="center" class="fullTable">

            <tr>
                <td>
                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                        class="fullTable" style="border-radius: 0 0 10px 10px;">
                        <tr>
                            <td>
