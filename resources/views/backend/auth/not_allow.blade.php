                                ...
                                <div class="form_container">
                                    ...
                                    <form class="app-form p-3" action="{{ route('register') }}" method="post">
                                        ...
                                        <div class="mb-3 text-center">
                                            ...
                                            Registrasi User sedang ditutup, silahkan hubungi team jika ingin mendaftar
                                            <a href="https://wa.me/62816600661" target="_blank" class="text-primary text-decoration-underline">Hubungi Admin</a>
                                            </p>
                                        </div>
