    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="form-group mb-3">
                        ...
                        <hr>
                        <small id="helper" class="form-text text-muted">Download format file import <a href="https://docs.google.com/spreadsheets/d/1TdFHCr2525m-t9461Ag-Cn_rxyIGWkmP9AkOGdFgi88/export?format=xlsx" target="_blank" class="text-danger">disini</a></small>
                    </div>
