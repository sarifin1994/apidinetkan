        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Payment Paid</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <label for="payment_paid" class="mb-1">Format Message<small></small></label>
                                <textarea name="payment_paid" id="payment_paid" style="height: 450px" class="form-control" placeholder="payment_paid"
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Kode Variabel Payment Paid</b><br><br>
                                ...
                                <li class="text-sm" style="margin-left:10px"><span class="text-danger">[metode_pembayaran]</span> Metode Pembayaran</li>
