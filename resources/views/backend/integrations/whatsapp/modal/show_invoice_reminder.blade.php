    <!-- Modal Show -->
    <div class="modal fade" id="show_invoice_reminder" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Invoice Reminder</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <label for="invoice_reminder" class="mb-1">Format Message<small></small></label>
                                <textarea name="invoice_reminder" id="invoice_reminder" style="height: 450px" class="form-control" placeholder="invoice_reminder"
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Kode Variabel Invoice Reminder</b><br><br>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="updateInvoiceReminder" type="submit">
                        Simpan
                    </button>
                </div>
            </div>
