    <!-- Modal Show -->
    <div class="modal fade" id="show_invoice_overdue" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Invoice Overdue</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <label for="invoice_overdue" class="mb-1">Format Message<small></small></label>
                                <textarea name="invoice_overdue" id="invoice_overdue" style="height: 450px" class="form-control" placeholder="invoice_overdue"
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Kode Variabel Invoice Overdue</b><br><br>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="updateInvoiceOverdue" type="submit">
                        Simpan
                    </button>
                </div>
            </div>
