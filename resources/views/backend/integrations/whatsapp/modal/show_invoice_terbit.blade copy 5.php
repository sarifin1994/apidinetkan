        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <label for="invoice_terbit">Format Message<small></small></label>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                ...
                                <li class="text-sm" style="margin-left:10px"><span class="text-danger">[paket_internet]</span> Profile PPPoE</li>
                                ...
                                <li class="text-sm" style="margin-left:10px"><span class="text-danger">[jumlah]</span> Jumlah</li>
                                ...
                                <li class="text-sm" style="margin-left:10px"><span class="text-danger">[total]</span> Total with PPN & Discount</li>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="updateTemplate" type="submit">
                        Simpan
                    </button>
                </div>
            </div>
