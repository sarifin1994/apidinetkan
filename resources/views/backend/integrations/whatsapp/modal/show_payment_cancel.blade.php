        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Payment Cancel</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <label for="payment_cancel" class="mb-1">Format Message<small></small></label>
                                <textarea name="payment_cancel" id="payment_cancel" style="height: 450px" class="form-control" placeholder="payment_cancel"
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Kode Variabel Payment Cancel</b><br><br>
