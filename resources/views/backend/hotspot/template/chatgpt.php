...
@foreach ($user as $item)
    ...
    <head>
        ...
        <style type="text/css">
            ...
            /* Hapus definisi warnalist karena tidak digunakan */
        </style>
    </head>
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 75px">
                                        ...
                                        <h1 style="margin: -12px 0 0 0; font-size: 14px; color: #fe0e01">{{ $nickname }}</h1>
                                    </td>
                ...
                <tr>
                    <td style="color: #666; border-collapse: collapse;" valign="top">
                        ...
                        <table style="width:100%; border-collapse: collapse;margin-top:5px">
                            <tbody>
                                <tr>
                                    <!-- Hardcode background merah untuk pesan -->
                                    <td style="background: red; padding:0;" valign="top" colspan="1">
                                        <div style="text-align:left; font-size:6px; font-weight:bold; margin:0; padding:2.5px; color:#fff;">
                                            <b>&nbsp;JANGAN DIBUANG SELAMA MASIH AKTIF</b>
                                        </div>
                                    </td>
                                    <td style="background: red; padding:0;" valign="top" colspan="1">
                                        <div style="text-align:left; font-size:6px; font-weight:bold; margin:0; padding:2.5px; color:#fff;">
