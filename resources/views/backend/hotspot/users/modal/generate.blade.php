    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" id="jml_voucher" name="jml_voucher"
                    ...
                    {{-- <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <input type="text" class="form-control" id="remark" name="remark"
                                placeholder="remark" autocomplete="off" required>
                ...
                Voucher <small class="text-sm">Profile</small>
                <hr />
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <label for="profile" class="mb-1">Assign Profile <small
                                class="text-danger">*</small></label>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" id="generate_voucher" type="submit">
                    Create
                </button>
            </div>
        </div>
