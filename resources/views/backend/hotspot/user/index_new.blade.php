...
<div class="container-fluid">
    <div class="row align-items-center mb-7">
        ...
        <div class="col-md-6 mb-3 mb-md-0">
            <h4 class="main-title">Hotspot User</h4>
        ...
        <div class="col-md-6 text-md-end">
            @if (multi_auth()->role === 'Admin')
                <div class="d-flex flex-wrap justify-content-md-end gap-2">
                    ...
                    <button class="btn btn-sm btn-success text-white" type="button" id="btn-print"
                        data-bs-toggle="modal" data-bs-target="#print" disabled>
                        <i class="ti ti-printer me-1"></i> Print
                        <span class="row-count badge bg-dark text-white"></span>
                    </button>

                    <button class="btn btn-sm btn-danger text-white" type="button" id="delete" disabled>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-xxl-3 mb-4">
                <div class="card text-center h-100">
                    ...
                    <div class="card-body eshop-cards">
                        <span class="ripple-effect"></span>
                        <h3 class="text-warning mb-0" id="totalnew">{{ $totalnew }}</h3>
                        <p class="mg-b-35 f-w-600 text-dark-800 txt-ellipsis-1">USER NEW</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-xxl-3 mb-4">
                <div class="card text-center h-100">
                    ...
                    <div class="card-body eshop-cards">
                        <span class="ripple-effect"></span>
                        <h3 class="text-danger mb-0" id="totalexpired">{{ $totalexpired }}</h3>
                        ...
                        <select data-column="7" class="form-select" id="filter_remark" name="filter_remark">
                            ...
                            @forelse ($remarks as $remark)
                                <option value="{{ $remark->created_at }}">
                                    ...
                                    {{ $remark->remark }} ({{ $remark->remark_count }})
                                </option>
                            @empty
                            @endforelse
                        </select>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.success) {
                    ...
                    $('#totaluser').html('<i class="ti ti-loader ti-spin f-s-16"></i>');
                    $('#totalactive').html('<i class="ti ti-loader ti-spin f-s-16"></i>');
                    $('#totalsuspend').html('<i class="ti ti-loader ti-spin f-s-16"></i>');
                    $('#totaldisabled').html('<i class="ti ti-loader ti-spin f-s-16"></i>');
