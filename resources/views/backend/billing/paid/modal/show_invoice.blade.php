        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">DETAIL INVOICE</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="no_invoice" name="no_invoice" disabled>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="item" name="item"
                                    placeholder="item" autocomplete="off" disabled>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="amount" name="amount"
                                    placeholder="amount" autocomplete="off" required disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label for="name" class="mb-1">Payment Total</label>
                                <input type="text" disabled class="form-control" id="payment_total"
                                    name="payment_total" placeholder="payment_total" autocomplete="off">
                            </div>
                        </div>
                    </div>
