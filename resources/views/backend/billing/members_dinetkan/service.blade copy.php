                ...
                @forelse ($mapping as $row)
                    ...
                    <td>
                      @if($row->status == 'unpaid')
                        <a href="javascript:void(0)" id="pay" data-id="{{ $row->id }}" class="btn btn-primary text-white" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
