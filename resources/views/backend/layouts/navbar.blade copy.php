        ...
        <nav class="navbar navbar-expand-xl navbar-vertical">
            <div class="container-lg">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a class="navbar-brand fs-5 fw-bold m-0 p-0" href="/">
                      <span class="material-symbols-outlined fs-4 me-1">network_check</span>
                      Radiusqu
                    </a>
                    {{-- <button id="sidebarToggle" class=""> --}}
                      <span id="toggleIcon" class="material-symbols-outlined fs-5">arrow_menu_close</span>
                    {{-- </button> --}}
                  </div>
