    ...
    <div class="row align-items-center mb-7">
        <div class="col-auto">
            ...
            <div class="avatar avatar-xl rounded text-primary">
                <i class="fs-2" data-duoicon="message-3"></i>
            </div>
        </div>
        <div class="col">
            <!-- Breadcrumb -->
    ...
    <div class="row">
        <div class="col-12 col-xxl-4">
            <div class="position-sticky mb-8" style="top: 40px">
                ...
                <div class="card bg-body mb-3">
                    ...
                    <!-- Avatar -->
                    <div class="rounded-circle mt-n2 mx-auto">
                        <span class="badge text-bg-primary fs-6"><span class="material-symbols-outlined">
                                info
                    ...
                    <div class="card-body text-center">
                        <!-- Heading -->
                        {{-- <h1 class="card-title fs-5">{{ multi_auth()->shortname }}</h1> --}}

                        <!-- Text -->
                        {{-- <p class="text-body-secondary mb-6">{{ multi_auth()->email }}</p> --}}
                        ...
                        <ul class="list-group list-group-flush mb-0">
                            @if($whatsapp->mpwa_server_server == 'mpwa')
                                <li class="list-group-item d-flex align-items-center justify-content-between bg-body px-0">
                                    <span class="text-body-secondary">Nomor Pengirim</span>
                                    <span>{{ $result['info'][0]['body'] ?? 'NULL' }}</span>
                                </li>
                                {{-- <li class="list-group-item d-flex align-items-center justify-content-between bg-body px-0">
                                    <span class="text-body-secondary">Pesan Terkirim</span>
                                    <span>{{ $result['info'][0]['message_sent'] ?? 'NULL' }}</span>
                                </li> --}}
                                {{-- <li class="list-group-item d-flex align-items-center justify-content-between bg-body px-0">
                                    <span class="text-body-secondary">Maksimal Pesan</span>
                                    <span>Unlimited</span>
                                </li> --}}
                                <li class="list-group-item d-flex align-items-center justify-content-between bg-body px-0">
                                    <span class="text-body-secondary">Status Device</span>
                ...
                <div class="row gx-3">
                    <div class="col">
                        <button class="btn btn-light w-100" data-bs-target="#scan" data-bs-toggle="modal"><span
                                class="material-symbols-outlined">
                                qr_code_scanner
                            </span> Scan</button>
                    </div>
                    <div class="col">
                        <button class="btn btn-light w-100" data-bs-target="#change" data-bs-toggle="modal"><span
                                class="material-symbols-outlined">
                                edit_square
                            </span> Ganti Nomor</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row p-3">
            ...
            <div class="col-lg-6 mt-3 modal-footer">
                <button class="btn btn-primary text-white me-2 mb-2 float-end" type="button" data-bs-toggle="modal"
                    data-bs-target="#broadcast">
                    <span class="material-symbols-outlined">
                        broadcast_on_home
                    </span> Kirim Broadcast
                </button>
                ...
                <button class="btn btn-danger text-white me-2 mb-2  float-end" id="delete" type="button"
...
<script type="text/javascript">
    ...
    return '<a href="javascript:void(0)" id="show_message" data-message="' + safeMessage + '">' + shortText + '</a>';
}
                    ...
                    $('#sendBroadcast').click(function(e) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                var sendData = {
                                    'tipe': $('#tipe').val(),
                                    'message': $('#message_expired_owner').val(),
                                    'wa': wa
                                };
                                $.ajaxSetup({
                                    headers: {
