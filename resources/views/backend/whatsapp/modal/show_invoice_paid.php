    <!-- Modal Show -->
    <div class="modal fade" id="show_payment_paid" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">Invoice Dibayar</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="payment_paid" id="payment_paid" style="height: 450px" class="form-control" placeholder=""
                                    autocomplete="off" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group mb-3">
                                <b class="text-sm">Kode Variabel Invoice Dibayar</b><br><br>
                                ...
                                <li class="text-sm" style="margin-left:10px"><span class="text-danger">[tgl_bayar]</span> Tanggal Dibayar</li>
                                <li class="text-sm" style="margin-left:10px"><span class="text-danger">[metode_pembayaran]</span> Metode Pembayaran</li><br>
                ...
                <button type="button" class="btn btn-link" data-bs-dismiss="modal">Close</button>
                    <button class="btn btn-primary" id="updatePaymentPaid" type="submit">
                        Save changes
                    </button>
                </div>
            </div>
