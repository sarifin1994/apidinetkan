    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/keuangan/transaksi/export') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="periode" class="mb-1">Pilih Periode<small class="text-danger">
                                *</small></label>
                        @php
                            $now = \Carbon\Carbon::now()->format('F-Y');
                        @endphp
                        <input type="text" readonly class="form-select" id="periode"
                            name="periode" value="{{ $now }}">
                    </div>
                    <div class="form-group mb-3">
