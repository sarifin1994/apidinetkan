...
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-7">
        ...
        <div class="col-md-6 mb-3 mb-md-0">
            <h4 class="main-title">Transaksi</h4>
            <ul class="app-line-breadcrumbs mb-0">
                ...
                <li class="active">
                    <a class="f-s-14 f-w-500" href="javascript:void(0)">Transaksi</a>
                </li>
            </ul>
        </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h4 class="fw-bold text-success mb-2" id="incomeMonth"
                                data-value="Rp{{ number_format($incomeMonth, 0, '.', '.') }}">
                                <i class="ti ti-loader-2 ti-spin me-1"></i>
                            </h4>
                            <div class="small">Hari Ini:
                        ...
                        <div class="bg-light rounded-circle p-3 text-success">
                            <i class="ti ti-arrow-bar-up fs-3"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h4 class="fw-bold text-danger mb-2" id="expenseMonth"
                        ...
                        <div class="bg-light rounded-circle p-3 text-danger">
                            <i class="ti ti-arrow-bar-down fs-3"></i>
                        </div>
                    </div>
                </div>
            </div>
