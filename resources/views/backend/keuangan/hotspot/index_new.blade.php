...
@section('main')
@section('title', 'Transaksi Hotspot')
<!-- Content -->
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-7">
        ...
        <div class="col-md-6 mb-3 mb-md-0">
            <h4 class="main-title">Transaksi Hotspot</h4>
            <ul class="app-line-breadcrumbs mb-0">
                ...
                <li class="active">
                    <a class="f-s-14 f-w-500" href="javascript:void(0)">Hotspot</a>
                </li>
            </ul>
        </div>
        ...
        <div class="d-flex flex-wrap justify-content-md-end gap-2">
            ...
            <button class="btn btn-success mb-2 text-white d-inline-flex align-items-center" data-bs-toggle="modal"
        ...
        <div class="row mb-5">
            ...
            <div class="col-12 col-md-4 col-xxl-3 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1">TOTAL PENJUALAN BULAN INI</h6>
                            <h4 class="mb-1 fw-semibold text-success" id="incomeMonth"
            ...
            <div class="col-12 col-md-4 col-xxl-3 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="text-muted mb-1">FEE RESELLER BULAN INI</h6>
                            <h4 class="mb-1 fw-semibold text-danger" id="feeReseller"
                                data-value="Rp{{ number_format($feeReseller, 0, '.', '.') }}">
                                <i class="ti ti-loader ti-spin me-1 text-muted"></i> Memuat...
                            </h4>
                        </div>
                        <div class="bg-light rounded-circle p-3">
                            <i class="ti ti-cash text-danger fs-3"></i>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        table.on('xhr.dt', function(e, settings, json) {
            if (json.summary) {
                ...
                $('#feeReseller').attr('data-value', 'Rp' + formatNumber(json.summary.feeReseller));
                updateSummaryValues();
            }
        });
