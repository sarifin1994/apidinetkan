...
<div class="container-fluid">
    <div class="row align-items-center mb-7">
        ...
        <div class="col-md-6 mb-3 mb-md-0">
            <h4 class="main-title">Tiket Gangguan</h4>
            <ul class="app-line-breadcrumbs mb-0">
                <li>
                    <a class="f-s-14 f-w-500" href="#">
                        <span><i class="ti ti-ticket f-s-16"></i> Tiket</span>
                    </a>
                </li>
                <li class="active">
                    <a class="f-s-14 f-w-500" href="javascript:void(0)">Gangguan</a>
                </li>
            </ul>
        </div>
        <div class="d-flex flex-wrap justify-content-md-end gap-2">
            ...
            <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#settings">
                <i class="ti ti-settings me-1"></i> Setting
            </button>
        </div>
    </div><br />
