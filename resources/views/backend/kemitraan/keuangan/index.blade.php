...
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-7">
        ...
        <div class="col-md-6 mb-3 mb-md-0">
            <h4 class="main-title">Transaksi Mitra</h4>
        ...
        <!-- <div class="d-flex flex-wrap justify-content-md-end gap-2">
            <div class="btn-group">
                <button type="button" class="btn btn-primary me-2 mb-2 dropdown-toggle" data-bs-toggle="dropdown"
                    ...
                    <span class="row-count badge bg-dark text-light ms-1"></span>
                </button>
    ...
    <div class="row mb-5">
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h4 class="fw-bold mb-0" id="totalmitra" data-value="{{ $totalmitra }}">
        ...
        <div class="col-12 col-md-4 col-xxl-3 mb-4">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1">KOMISI BULAN INI</h6>
                        <h4 class="fw-bold mb-0 text-success" id="incomeMonth"
        ...
        <!-- Card: Komisi Bulan Lalu -->
        <div class="col-12 col-md-4 col-xxl-3 mb-4">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1">KOMISI BULAN LALU</h6>
                        <h4 class="fw-bold mb-0 text-warning" id="incomeLastMonth"
                            data-value="Rp{{ number_format($incomeLastMonth, 0, '.', '.') }}">
                            <i class="ti ti-loader ti-spin me-1"></i>
                        </h4>
                    </div>
                    <div class="bg-light rounded-circle p-3">
                        <i class="ti ti-calendar-stats fs-3 text-warning"></i>
                    </div>
                </div>
            </div>
        </div>

        <!-- Card: Komisi Tahun Ini -->
        <div class="col-12 col-md-4 col-xxl-3 mb-4">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1">KOMISI TAHUN INI</h6>
                        <h4 class="fw-bold mb-0 text-info" id="incomeYear"
                            data-value="Rp{{ number_format($incomeYear, 0, '.', '.') }}">
                            <i class="ti ti-loader ti-spin me-1"></i>
                        </h4>
                    </div>
                    <div class="bg-light rounded-circle p-3">
                        <i class="ti ti-calendar-event fs-3 text-info"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $('#store_income').click(function(e) {
            ...
            btn.prop('disabled', true).html(
                '<i class="ti ti-loader ti-spin me-1"></i> Processing...');
        ...
        $('#store_expense').click(function(e) {
            ...
            // Ubah tampilan tombol: nonaktifkan tombol dan tampilkan spinner progress activity
            btn.prop('disabled', true).html(
                '<i class="ti ti-loader ti-spin me-1"></i> Memproses...');
            var data = {
        ...
        $('#update_income').click(function(e) {
            ...
            btn.prop('disabled', true).html(
                '<i class="ti ti-loader-2 ti-spin me-1"></i> Memproses...');
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
