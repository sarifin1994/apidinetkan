    ...
    <div class="row mb-8">
      ...
      <div class="col-12 col-md-6 col-xxl-3 mb-4 mb-md-0">
        <div class="card bg-body-tertiary border-transparent">
          <a href="/pppoe/user" style="text-decoration: none; color: inherit;">
            <div class="card-body">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <!-- Nilai dinamis dengan spinner -->
                  <div class="fs-lg fw-semibold" id="pppoeonline" data-value="{{ $pppoepending }}">
                    <span class="material-symbols-outlined spinner">progress_activity</span>
                  </div>
                </div>
                <div class="col-auto">
      ...
      <div class="col-12 col-md-6 col-xxl-3 mb-4 mb-md-0">
        <div class="card bg-body-tertiary border-transparent">
          <a href="/keuangan/mitra" style="text-decoration: none; color: inherit;">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col">
                  <!-- Heading -->
                  ...
                  <!-- Nilai dinamis dengan spinner -->
                  <div class="fs-lg fw-semibold" id="totalkomisi" data-value="{{ number_format($totalkomisi, 0, ',', '.') }}">
                    <span class="material-symbols-outlined spinner">progress_activity</span>
                  </div>
                </div>
                <div class="col-auto">
