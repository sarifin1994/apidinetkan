...
<body>
    <div class="container">
        ...
        <p>Selamat, akun Anda telah berhasil didaftarkan. Berikut adalah informasi akun Anda:</p>
        <div class="info">
            <p><strong>Username:</strong> {{$data['username']}}</p>
            <p><strong>Password:</strong> {{$data['password']}}</p>
            <p><strong><a href="{{env('APP_URL')}}">Login Klik Disini</a></strong></p>
        </div>
        <p>Silakan gunakan informasi ini untuk masuk ke akun Anda.</p>
        <p>Jika Anda tidak merasa mendaftar, harap abaikan email ini atau hubungi tim dukungan kami.</p>
        </div>
        <div class="footer">
