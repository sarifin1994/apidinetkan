...
class SuspendCycleCron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'suspend_cycle:cron';
     ...
     * @var string
     */
    protected $description = 'Suspend Billing Cycle';
            ...
            if ($suspend_date !== 0) {
                ...
                $invoices = Invoice::where('group_id', $user->id_group)
                    ...
                    ->with([
                        'service',
                        'service.member',
                        'service.pppoe:id,username,value,profile,nas',
                    ])
                    ->get();
