...
class PascabayarFixedCron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'pascabayar_fixed:cron';
     ...
     * @var string
     */
    protected $description = 'Invoice Pascabayar Fixed Date';
    ...
    public function handle()
    {
        ...
        Log::info($count . ' Invoice Pascabayar Fixed Date executed successfully at ' . date('Y-m-d H:i:s'));
    }
}
