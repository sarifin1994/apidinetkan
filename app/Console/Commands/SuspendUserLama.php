...
class SuspendUserLama extends Command
{
    ...
    protected function buildMessage($user): string
    {
        ...
        Untuk memastikan kelancaran layanan dan akses penuh ke fitur Radiusqu, mohon segera perpanjangan lisensi di dashboard `{env('APP_URL')}`.
