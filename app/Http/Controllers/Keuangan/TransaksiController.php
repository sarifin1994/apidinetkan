...
class TransaksiController extends Controller
{
    public function index()
    {
        ...
        $totalIncome = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pemasukan')->whereNot('metode','Radius')->whereNot('created_by','midtrans')->whereNot('created_by','duitku')->sum('nominal');
        $totalExpense = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pengeluaran')->whereNot('metode','Radius')->whereNot('created_by','midtrans')->whereNot('created_by','duitku')->sum('nominal');
        $totalBalance = $totalIncome - $totalExpense;

        $totalIncomeCash = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pemasukan')->where('metode', 'Cash')->whereNot('metode','Radius')->sum('nominal');
        $totalExpenseCash = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pengeluaran')->where('metode', 'Cash')->whereNot('metode','Radius')->sum('nominal');
        $totalCash = $totalIncomeCash - $totalExpenseCash;

        $totalIncomeTransfer = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pemasukan')->where('metode', 'Transfer')->whereNot('metode','Radius')->sum('nominal');
        $totalExpenseTransfer = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pengeluaran')->where('metode', 'Transfer')->whereNot('metode','Radius')->sum('nominal');
        ...
        $incomeDay = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pemasukan')->whereNot('created_by','midtrans')->whereNot('created_by','duitku')->whereNot('metode','Radius')
        ->whereDate('tanggal', Carbon::today())->sum('nominal');
        $expenseDay = Transaksi::where('shortname', multi_auth()->shortname)->where('tipe', 'Pengeluaran')->whereNot('created_by','midtrans')->whereNot('created_by','duitku')->whereNot('metode','Radius')
        ->whereDate('tanggal', Carbon::today())->sum('nominal');
        ...
        return view('backend.keuangan.transaksi.index_new', compact('kategori_pemasukan', 'kategori_pengeluaran', 'incomeMonth', 'expenseMonth', 'totalBalance', 'totalCash', 'totalTransfer', 'incomeDay', 'expenseDay'));
    }
