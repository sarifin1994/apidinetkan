...
class TransaksiDinetkanController extends Controller
{
...
//                })
        ...
        return view('backend.dinetkan.keuangan.index', compact('incomeMonth','incomeLastMonth','incomeYear','totalSaldo','duitku'));
    }
